// Source: https://www.evopdf.com/help/evopdf-next-dotnet/html/merge-multiple-html-to-pdf.htm
// Documentation page: Merge Multiple HTML to PDF
...
namespace EvoPdf_Next_AspNetDemo.Controllers.HTML_to_PDF
{
    public class Merge_Multiple_HTML_to_PDFController : Controller
    {
        ...
        {
            var model = new Merge_Multiple_HTML_to_PDF_ViewModel();
            return View(model);
        }        

        [HttpPost]
        public ActionResult MergePdf(Merge_Multiple_HTML_to_PDF_ViewModel model)
        {
        ...
        private void SetHtmlToPdfConverterOptions(HtmlToPdfConverter htmlToPdfConverter, Merge_Multiple_HTML_to_PDF_ViewModel model)
        {
        ...
        private void SetPdfMergeOptions(PdfMerge pdfMerge, Merge_Multiple_HTML_to_PDF_ViewModel model)
        {
