...
namespace EvoPdf_Next_AspNetDemo.Models.RTF_to_PDF
{
    public class RTF_to_PDF_ViewModel
    {
        public string RtfFileUrl { get; set; }
        public IFormFile RtfFile { get; set; }
        ...
        public int RtfViewerZoom { get; set; } = 100;
